...
const Locale = document.documentElement.lang,
    ...
    COLS = {
        ...
        cars: ({
            ...
            bodyRender: (row) => Neo.Helper.Str.capitalize(row.category ? row.category.name_en : empty()),
            bodyPdfRender: function(row) {
                return this.bodyRender(row);
            },
            bodyCsvRender: function(row) {
        ...
        reservations: ({
            ...
            bodyRender: (row) => Neo.Helper.Str.capitalize(row.car ? row.car.name_en : empty()),
            bodyPdfRender: function(row) {
                return this.bodyRender(row);
            },
            bodyCsvRender: function(row) {
