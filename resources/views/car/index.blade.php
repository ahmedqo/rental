...
@section('title', __('Cars List'))

@section('content')
    <div class="flex flex-col gap-2">
        <neo-datavisualizer print search filter download title="{{ __('Cars List') }}">
            <a slot="end" title="{{ __('Create') }}" href="{{ route('views.cars.store') }}" aria-label="create_page_link"
