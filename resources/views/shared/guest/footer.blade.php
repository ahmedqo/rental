<footer class="lg:py-6 bg-x-black">
    <div class="w-full container mx-auto p-4 grid grid-rows-1 grid-cols-1 sm:grid-cols-12 gap-10 lg:gap-12">
        <div class="w-full sm:col-span-12 lg:col-span-5 flex flex-col gap-6">
            <a href="{{ route('views.guest.index') }}" aria-label="{{ env('APP_NAME') }} home page" class="block w-36">
            ...
            <div class="w-full flex flex-col gap-4">
                <p class="text-base font-medium text-x-white text-justify">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nemo saepe natus sit doloremque eveniet
                    tempore ea perferendis culpa rerum debitis!
                </p>
                <ul class="flex gap-4 items-start flex-wrap">
                    <li>
                        <a href="" aria-label="{{ env('APP_NAME') }} instagram page"
                            class="flex text-x-prime text-sm">
                            <svg class="block w-6 h-6 pointer-events-none" fill="currentColor" viewBox="0 0 31 30">
                                <path
                    ...
                    <li>
                        <a href="" aria-label="{{ env('APP_NAME') }} tiktok page"
                            class="flex text-x-prime text-sm">
                            <svg class="block w-6 h-6 pointer-events-none" fill="currentColor" viewBox="0 0 32 32">
                                <path
                    ...
                    <li>
                        <a href="" aria-label="{{ env('APP_NAME') }} favebook page"
                            class="flex text-x-prime text-sm">
                            <svg class="block w-6 h-6 pointer-events-none" fill="currentColor" viewBox="0 0 32 32">
                                <path
                    ...
                    <li>
                        <a href="" aria-label="{{ env('APP_NAME') }} x page" class="flex text-x-prime text-sm">
                    ...
                    <li>
                        <a href="" aria-label="{{ env('APP_NAME') }} telegram channel"
                            class="flex text-x-prime text-sm">
                            <svg class="block w-6 h-6 pointer-events-none" fill="currentColor" viewBox="0 0 50 50">
                                <path
                    ...
                    <li>
                        <a href="" aria-label="{{ env('APP_NAME') }} youtube channel"
                            class="flex text-x-prime text-sm">
                            <svg class="block w-6 h-6 pointer-events-none" fill="currentColor" viewBox="0 0 310 310">
                                <path
            ...
            <ul class="w-full flex flex-col gap-4 md:gap-2 items-start">
                ...
                <li class="w-full flex flex-wrap gap-2 items-center">
                    ...
                    <div class="flex flex-col flex-1">
                        <a href="mailto:test@test.com" aria-label="{{ env('APP_NAME') }} contact email address"
                ...
                <li class="w-full flex flex-wrap gap-2 items-center">
                    ...
                    <div class="flex flex-col flex-1">
                        <a href="tel:XXXXXXXXXX" aria-label="{{ env('APP_NAME') }} contact phone number"
                            class="text-x-white text-sm font-x-thin text-start">
                            XXXXXXXXXX
                        </a>
                    </div>
