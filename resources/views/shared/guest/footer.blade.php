<footer class="bg-x-black py-3 sm:py-6">
    <div class="w-full container mx-auto p-4 grid grid-rows-1 grid-cols-1 sm:grid-cols-12 gap-10 lg:gap-12">
            ...
            <ul class="w-full flex flex-col gap-4 md:gap-2 items-start">
                ...
                <li class="w-full flex flex-wrap gap-2 items-center">
                    ...
                    <div class="flex flex-col flex-1">
                        <a href="mailto:test@test.com" aria-label="email_address"
                ...
                <li class="w-full flex flex-wrap gap-2 items-center">
                    ...
                    <div class="flex flex-col flex-1">
                        <a href="tel:XXXXXXXXXX" aria-label="phone_number"
                            class="text-x-white text-sm font-x-thin text-start">
                            XXXXXXXXXX
                        </a>
                    </div>
        ...
        <ul class="flex gap-4 sm:gap-6 lg:gap-10 items-center justify-center flex-wrap sm:col-span-12">
            <li>
                <a href="" aria-label="instagram_page" class="flex text-x-prime text-sm">
            ...
            <li>
                <a href="" aria-label="tiktok_page" class="flex text-x-prime text-sm">
                    <svg class="block w-8 h-8  sm:w-10 sm:h-10 pointer-events-none" fill="currentColor"
                        viewBox="0 0 32 32">
                        <path
            ...
            <li>
                <a href="" aria-label="favebook_page" class="flex text-x-prime text-sm">
                    <svg class="block w-8 h-8  sm:w-10 sm:h-10 pointer-events-none" fill="currentColor"
                        viewBox="0 0 32 32">
                        <path
            ...
            <li>
                <a href="" aria-label="x_page" class="flex text-x-prime text-sm">
                    <svg class="block w-8 h-8  sm:w-10 sm:h-10 pointer-events-none" fill="currentColor"
            ...
            <li>
                <a href="" aria-label="telegram_channel" class="flex text-x-prime text-sm">
                    <svg class="block w-8 h-8  sm:w-10 sm:h-10 pointer-events-none" fill="currentColor"
                        viewBox="0 0 50 50">
                        <path
            ...
            <li>
                <a href="" aria-label="youtube_channel" class="flex text-x-prime text-sm">
                    <svg class="block w-8 h-8  sm:w-10 sm:h-10 pointer-events-none" fill="currentColor"
                        viewBox="0 0 310 310">
                        <path
