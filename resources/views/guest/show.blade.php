        ...
        <section class="bg-x-white shadow-x-core sticky top-0 left-0 right-0 z-[1]">
            <div class="w-full mx-auto container">
                <ul class="flex flex-wrap px-4 overflow-auto">
                    ...
                    @if ($car->details)
                        <li>
                            <a href="#details" class="tabs block w-max px-4 py-3 font-x-thin text-x-black text-opacity-70">
                                {{ __('Détails') }}
                            </a>
                        </li>
                    @endif
                    ...
                    @if ($car->Images->count() > 1)
                        <li>
                            <a href="#gallery" class="tabs block w-max px-4 py-3 font-x-thin text-x-black text-opacity-70">
                                {{ __('Gallery') }}
                            </a>
                        </li>
                    @endif
            ...
            <div class="w-full mx-auto container p-4">
                <div class="w-full grid grid-rows-1 grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10">
                    <div class="w-full lg:col-span-2 flex flex-col gap-6">
                                ...
                                <li class="w-full mt-2">
                                    <ul class="w-full lg:w-2/3 grid grid-rows-1 grid-cols-2 gap-2">
                                        <li class="w-max flex flex-wrap items-center gap-2">
                                            ...
                                            <h6 class="text-base text-x-black text-opacity-50 font-normal">
                        ...
                        @endif
                        <div id="policies" class="w-full flex flex-col gap-4 p-4 bg-x-white shadow-x-core rounded-x-thin">
                            <h3 class="text-x-black font-x-huge text-xl">
                                {{ __('Rental Policies') }}
                            </h3>
                        </div>
                    ...
                    <div class="w-full flex flex-col gap-6">
                        ...
                        <div class="w-full flex flex-col gap-4 p-4 bg-x-white shadow-x-core rounded-x-thin">
                            ...
                            <form class="grid grid-rows-1 grid-cols-2 gap-4">
                                <neo-textbox label="{{ __('Full Name') }}" value="{{ old('name') ?? '' }}"
    ...
    <script>
        ...
        tabs.forEach(t => {
            t.addEventListener("click", e => {
                tabs.forEach(tt => {
                    tt.classList[t === tt ? "add" : "remove"]("active");
                });
                e.preventDefault();
