...
@section('title', __('Blogs List'))

@section('content')
    <div class="flex flex-col gap-2">
        <neo-datavisualizer print search filter download title="{{ __('Blogs List') }}">
            <a slot="end" title="{{ __('Create') }}" href="{{ route('views.blogs.store') }}" aria-label="create_page_link"
...
@section('scripts')
    <script>
        TableVisualizer(document.querySelector("neo-datavisualizer"), "blogs", {
